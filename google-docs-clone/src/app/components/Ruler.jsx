...
const Ruler = () => {
  ...
  return (
    <div
      ...
      className="w-[816px] mx-auto h-8 border-b border-gray-300 flex items-end relative select-none print:hidden"
    >
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      ...
                      <span className="absolute bottom-2 text-[12px] text-neutral-500 transform -translate-x-1/2">
                        {marker / 10 + 1}
                      </span>
                    </>
                  )}
